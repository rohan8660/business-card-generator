...
def create_business_card(name, email, phone, template_file=None, debug=False):
    """
...
def generate_card():
    ...
    card = create_business_card(name, email, phone, template_file=template_file, debug=debug)
